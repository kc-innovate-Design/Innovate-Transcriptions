...
export const ALL_ATTENDEES: Attendee[] = [
  ...
  { id: '31', name: 'IP Admin', email: 'ipadmin@innovate-design.com', department: 'Business Support' },
  ...
  { id: '33', name: 'George Beckwith', email: 'george.beckwith@innovate-design.com', department: 'Designer' },
  { id: '34', name: 'Hermione Moore', email: 'hermione.moore@innovate-design.com', department: 'Designer' },
  ...
  { id: '35', name: 'Liam Earle', email: 'liam.earle@innovate-design.com', department: 'Designer' },
  { id: '36', name: 'Megan Flandrin', email: 'Megan.Flandrin@innovate-design.com', department: 'Designer' },
