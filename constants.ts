import { LayoutDashboardIcon, UsersIcon, HistoryIcon, SettingsIcon } from 'lucide-react';
...
export const MEETING_TYPES = [
  { id: 'strategy', label: 'Strategy', icon: LayoutDashboardIcon, description: 'High-level planning and roadmap sessions.' },
  { id: 'workshop', label: 'Workshop', icon: UsersIcon, description: 'Collaborative ideation and problem-solving.' },
  { id: 'review', label: 'Review', icon: HistoryIcon, description: 'Project milestones and feedback sessions.' },
  { id: 'admin', label: 'Admin', icon: SettingsIcon, description: 'Internal team syncs and logistics.' },
];
